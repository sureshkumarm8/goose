 ...
 * href="http://java.sun.com/docs/books/effective/index.html">Effective Java</a> , by Joshua Bloch. In particular the rule for comparing
 * <code>doubles</code>, <code>floats</code>, and arrays can be tricky. Also, making sure that <code>equals()</code> and
 * <code>hashCode()</code> are consistent can be difficult.
 * </p>
 * <p/>
 * <p>
 ...
 * <p/>
 * <p>
 * All relevant fields should be included in the calculation of equals. Derived fields may be ignored. In particular, any field used in
 ...
 * method, <code>reflectionEquals</code>, uses <code>AccessibleObject.setAccessible</code> to change the visibility of the fields. This will
 * fail under a security manager, unless the appropriate permissions are set up correctly. It is also slower than testing explicitly.
 * </p>
 * <p/>
 * <p>
