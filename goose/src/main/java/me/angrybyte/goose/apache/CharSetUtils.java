...
/**
 * <p>Operations on {@code CharSet} instances.</p> <p/> <p>This class handles {@code null} input gracefully. An exception will not be thrown for a {@code null}
 * input. Each method documents its behaviour in more detail.</p> <p/> <p>#ThreadSafe#</p>
 *
...
public class CharSetUtils {
    ...
    /**
     * <p>CharSetUtils instances should NOT be constructed in standard programming. Instead, the class should be used as {@code
     * CharSetUtils.evaluateSet(null);}.</p> <p/> <p>This constructor is public to permit tools that require a JavaBean instance to operate.</p>
     */
    public CharSetUtils() {
        super();
    }
    ...
    /**
     * <p>Squeezes any repetitions of a character that is mentioned in the supplied set.</p>
     * <p/>
     * <pre>
    ...
    /**
     * <p>Takes an argument in set-syntax, see evaluateSet, and returns the number of characters present in the specified string.</p>
     * <p/>
     * <pre>
    ...
    /**
     * <p>Takes an argument in set-syntax, see evaluateSet, and keeps any of characters present in the specified string.</p>
     * <p/>
     * <pre>
    ...
    /**
     * <p>Takes an argument in set-syntax, see evaluateSet, and deletes any of characters present in the specified string.</p>
     * <p/>
     * <pre>
